...
DROP ROLE "example-misskey-user";
...
CREATE ROLE "example-misskey-user";
ALTER ROLE "example-misskey-user" WITH SUPERUSER INHERIT CREATEROLE CREATEDB LOGIN REPLICATION BYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:2Rt9rQwwgivwqQ0cpyDeFQ==$1odtKyfGF4WWh26sVEmNdl5c/m5ci6TothUkTeudIe4=:aE43YTokkYKfYlpLgGByV/YH5uDxakPy9OXcbN5sYiI=';
...
--
-- Name: template1; Type: DATABASE; Schema: -; Owner: example-misskey-user
--

CREATE DATABASE template1 WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE_PROVIDER = libc LOCALE = 'en_US.utf8';


ALTER DATABASE template1 OWNER TO "example-misskey-user";
...
--
-- Name: DATABASE template1; Type: COMMENT; Schema: -; Owner: example-misskey-user
--
...
--
-- Name: template1; Type: DATABASE PROPERTIES; Schema: -; Owner: example-misskey-user
--
...
--
-- Name: DATABASE template1; Type: ACL; Schema: -; Owner: example-misskey-user
--
...
--
-- Name: misskey; Type: DATABASE; Schema: -; Owner: example-misskey-user
--

CREATE DATABASE misskey WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE_PROVIDER = libc LOCALE = 'en_US.utf8';


ALTER DATABASE misskey OWNER TO "example-misskey-user";
...
--
-- Name: instance_suspensionstate_enum; Type: TYPE; Schema: public; Owner: example-misskey-user
--
...
ALTER TYPE public.instance_suspensionstate_enum OWNER TO "example-misskey-user";
...
--
-- Name: abuse_report_notification_recipient; Type: TABLE; Schema: public; Owner: example-misskey-user
--
...
ALTER TABLE public.abuse_report_notification_recipient OWNER TO "example-misskey-user";
...
CREATE TABLE public.meta (
    ...
    "urlPreviewUserAgent" character varying(1024) DEFAULT NULL::character varying,
    ...
    federation character varying(128) DEFAULT 'all'::character varying NOT NULL,
...
--
-- Name: COLUMN poll."channelId"; Type: COMMENT; Schema: public; Owner: example-misskey-user
--
...
--
-- Name: system_account; Type: TABLE; Schema: public; Owner: example-misskey-user
--
...
ALTER TABLE public.system_account OWNER TO "example-misskey-user";

--
-- Name: system_webhook; Type: TABLE; Schema: public; Owner: example-misskey-user
--
...
ALTER TABLE public.system_webhook OWNER TO "example-misskey-user";
...
--
-- Data for Name: abuse_report_notification_recipient; Type: TABLE DATA; Schema: public; Owner: example-misskey-user
--
...
COPY public.abuse_user_report (id, "targetUserId", "reporterId", "assigneeId", resolved, comment, "targetUserHost", "reporterHost", forwarded, "moderationNote", "resolvedAs") FROM stdin;
\.
...
COPY public.instance (id, "firstRetrievedAt", host, "usersCount", "notesCount", "followingCount", "followersCount", "latestRequestReceivedAt", "isNotResponding", "softwareName", "softwareVersion", "openRegistrations", name, description, "maintainerName", "maintainerEmail", "infoUpdatedAt", "suspensionState", "iconUrl", "themeColor", "faviconUrl", "moderationNote", "notRespondingSince") FROM stdin;
\.
...
283	1709126576000	OptimizeEmojiIndex1709126576000
284	1710512074000	UrlPreviewMeta1710512074000
285	1710919614510	AntennaExcludeBots1710919614510
286	1713656541000	AbuseReportNotification1713656541000
287	1716129964060	ChannelIdDenormalizedForMiPoll1716129964060
288	1716197366117	MediaSilenceForHosts1716197366117
289	1716345015347	NotRespondingSince1716345015347
290	1716345771510	SuspensionStateInsteadOfIsSspended1716345771510
291	1716450883149	RemoveAntennaNotify1716450883149
292	1717117195275	InquiryUrl1717117195275
293	1721666053703	FixDriveUrl1721666053703
294	1723944246767	FollowedMessage1723944246767
295	1726804538569	ReactionsBuffering1726804538569
296	1727318020265	EnableStatsForFederatedInstances1727318020265
297	1727491883993	UserScore1727491883993
298	1727512908322	MetaFederation1727512908322
299	1728085812127	RefineAbuseUserReport1728085812127
300	1728550878802	Testcaptcha1728550878802
301	1728634286056	ProhibitedWordsForNameOfUser1728634286056
302	1729333924409	SigninRequiredForShowContents1729333924409
303	1729486255072	MakeNotesHiddenBefore1729486255072
304	1739006797620	GoogleAnalytics1739006797620
305	1740121393164	SystemAccounts1740121393164
306	1740129169650	SystemAccounts21740129169650
307	1740133121105	SystemAccounts31740133121105
...
a5z29dwblul70002	2025-03-30 10:27:45.947+00	a5z29df4lul70001	widgets	{client,base}	\N	[{"id": "a", "data": {}, "name": "calendar", "place": "right"}, {"id": "b", "data": {}, "name": "notifications", "place": "right"}, {"id": "c", "data": {}, "name": "trends", "place": "right"}]
a5z29fcglul70003	2025-03-30 10:28:07.474+00	a5z29df4lul70001	accountSetupWizard	{client,base}	\N	-1
\.
...
--
-- Data for Name: system_account; Type: TABLE DATA; Schema: public; Owner: example-misskey-user
--

COPY public.system_account (id, "userId", type) FROM stdin;
a5zycyyn32fb0002	a5zycyyd32fb0001	proxy
\.


--
-- Data for Name: system_webhook; Type: TABLE DATA; Schema: public; Owner: example-misskey-user
--
...
hoge	2025-03-30 10:27:45.337+00
system.proxy	2025-03-31 01:26:20.926+00
\.
...
a5z29df4lul70001	-----BEGIN PUBLIC KEY-----\\nPQIDAQAB\n-----END PUBLIC KEY-----\n	-----BEGIN PRIVATE KEY-----\\n-----END PRIVATE KEY-----\n
a5zycyyd32fb0001	-----BEGIN PUBLIC KEY-----\\n3QIDAQAB\n-----END PUBLIC KEY-----\n	-----BEGIN PRIVATE KEY-----\\n-----END PRIVATE KEY-----\n
\.
...
--
-- Name: abuse_report_notification_recipient PK_abuse_report_notification_recipient_id; Type: CONSTRAINT; Schema: public; Owner: example-misskey-user
--

ALTER TABLE ONLY public.abuse_report_notification_recipient
    ADD CONSTRAINT "PK_abuse_report_notification_recipient_id" PRIMARY KEY (id);
...
--
-- Name: system_account PK_edb56f4aaf9ddd50ee556da97ba; Type: CONSTRAINT; Schema: public; Owner: example-misskey-user
--
...
--
-- Name: system_webhook PK_system_webhook_id; Type: CONSTRAINT; Schema: public; Owner: example-misskey-user
--

ALTER TABLE ONLY public.system_webhook
    ADD CONSTRAINT "PK_system_webhook_id" PRIMARY KEY (id);
...
--
-- Name: IDX_3ede46f507c87ad698051d56a8; Type: INDEX; Schema: public; Owner: example-misskey-user
--
...
--
-- Name: IDX_41a3c87a37aea616ee459369e1; Type: INDEX; Schema: public; Owner: example-misskey-user
--
...
--
-- Name: IDX_EMOJI_CATEGORY; Type: INDEX; Schema: public; Owner: example-misskey-user
--
...
--
-- Name: IDX_EMOJI_ROLE_IDS; Type: INDEX; Schema: public; Owner: example-misskey-user
--
...
--
-- Name: IDX_abuse_report_notification_recipient_isActive; Type: INDEX; Schema: public; Owner: example-misskey-user
--
...
--
-- Name: IDX_abuse_report_notification_recipient_method; Type: INDEX; Schema: public; Owner: example-misskey-user
--
...
--
-- Name: IDX_abuse_report_notification_recipient_systemWebhookId; Type: INDEX; Schema: public; Owner: example-misskey-user
--
...
--
-- Name: IDX_abuse_report_notification_recipient_userId; Type: INDEX; Schema: public; Owner: example-misskey-user
--
...
--
-- Name: IDX_c1240fcc9675946ea5d6c2860e; Type: INDEX; Schema: public; Owner: example-misskey-user
--
...
--
-- Name: IDX_c362033aee0ea51011386a5a7e; Type: INDEX; Schema: public; Owner: example-misskey-user
--
...
--
-- Name: IDX_system_webhook_isActive; Type: INDEX; Schema: public; Owner: example-misskey-user
--
...
--
-- Name: IDX_system_webhook_on; Type: INDEX; Schema: public; Owner: example-misskey-user
--
...
--
-- Name: system_account FK_41a3c87a37aea616ee459369e12; Type: FK CONSTRAINT; Schema: public; Owner: example-misskey-user
--
...
--
-- Name: abuse_report_notification_recipient FK_abuse_report_notification_recipient_systemWebhookId; Type: FK CONSTRAINT; Schema: public; Owner: example-misskey-user
--
...
--
-- Name: abuse_report_notification_recipient FK_abuse_report_notification_recipient_userId1; Type: FK CONSTRAINT; Schema: public; Owner: example-misskey-user
--
...
--
-- Name: abuse_report_notification_recipient FK_abuse_report_notification_recipient_userId2; Type: FK CONSTRAINT; Schema: public; Owner: example-misskey-user
--
...
--
-- Name: postgres; Type: DATABASE; Schema: -; Owner: example-misskey-user
--

CREATE DATABASE postgres WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE_PROVIDER = libc LOCALE = 'en_US.utf8';


ALTER DATABASE postgres OWNER TO "example-misskey-user";
...
--
-- Name: DATABASE postgres; Type: COMMENT; Schema: -; Owner: example-misskey-user
--
