    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          data-slot="sidebar"
          data-mobile="true"
          className="w-[var(--sidebar-width)] cursor-pointer bg-sidebar p-0 text-sidebar-foreground [&>button]:hidden"
          style={
            {
...
function SidebarContent({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "flex min-h-0 flex-1 flex-col gap-2 overflow-auto px-2 group-data-[collapsible=icon]:overflow-hidden", // px-2を追加
        className,
      )}
      {...props}
    />
