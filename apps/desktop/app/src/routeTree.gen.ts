...
const SignupRouteRoute = SignupRouteImport.update({
  ...
  import("./../routes/signup/route.lazy").then((d) => d.Route),
);
...
const LoginRouteRoute = LoginRouteImport.update({
  ...
  import("./../routes/login/route.lazy").then((d) => d.Route),
);
...
const AuthRouteRoute = AuthRouteImport.update({
  ...
  import("./../routes/auth/route.lazy").then((d) => d.Route),
);
...
const AuthedCreateTimelineRouteLazyRoute =
  AuthedCreateTimelineRouteLazyImport.update({
    ...
    import("./../routes/_authed/create-timeline/route.lazy").then(
      (d) => d.Route,
    ),
  );
