    ...
    <div>
      <h2 className="flex items-center gap-4">
        ...
        <div className="rounded-md bg-primary/10 p-1">
          <img src="res://icons/vite.png" className="h-4 w-4" alt="Vite logo" />
        </div>
      </h2>
      <p>
        Combine Electron's desktop capabilities with Vite's lightning-fast
        development experience.
      </p>
      <p>
        This powerful combination delivers exceptional developer experience with
        instant HMR, while allowing you to build feature-rich desktop
        applications.
      </p>
