...
const ShadContent = () => {
  return (
    <div>
      ...
      <p>
        Shadcn UI provides a set of accessible, customizable, and beautiful
        components that you can copy and paste into your apps. It's not a
        component library, but a collection of re-usable components that you can
        copy and customize.
      </p>
